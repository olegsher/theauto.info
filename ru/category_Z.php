...
<html lang="ru">
<head>
<title>Аренда минивен Ford Transit, VW Transporter, Citroen Jumpy или похожие в данной категории проката, автомат 9 мест в Израиле +972-58-7710101</title>
      ...
      <form action="mail_send.php" method="post">
  					<div class="form-inline">
   					 <div class="col-auto"><input type="text" class="form-control"  required name="name" placeholder="ваше имя"></div>
  				  	 <div class="col-auto"><input type="tel" class="form-control"  required name="phone" placeholder="телефон\whatsapp\viber включая код страны города"></div>    			  
